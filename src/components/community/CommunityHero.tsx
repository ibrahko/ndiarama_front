      ...
      <div className="max-w-6xl mx-auto">
        <div className="rounded-[32px] bg-gradient-to-r from-[#2a1b17] via-[#4b3027] to-[#8c543b] px-7 py-8 md:px-10 md:py-10">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a
              href="#features"
              className="inline-flex items-center justify-center rounded-lg bg-white px-5 py-2.5 text-xs font-semibold text-[#2b211d] transition hover:bg-[#f4ece6]"
            >
              Rejoindre la communauté
            </a>
            <a
              href="#programs"
              className="inline-flex items-center justify-center rounded-lg border border-white/20 bg-transparent px-5 py-2.5 text-xs font-semibold text-white transition hover:bg-white/10"
            >
              Voir les programmes →
            </a>
          </div>
