        ...
        <div className="grid gap-8 md:gap-12 md:grid-cols-[1.05fr,0.95fr] items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                href="/services"
                className="inline-flex items-center justify-center rounded-lg border border-ndiarama-light/80 px-5 py-3 text-sm font-medium text-ndiarama-text bg-white/70 transition hover:bg-white hover:-translate-y-0.5"
              >
