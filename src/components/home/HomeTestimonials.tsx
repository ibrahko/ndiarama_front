...
/**
 * Carrousel de temoignages — avance automatiquement toutes les 4,5 s.
 * Utilise le hook useCarousel pour la logique de navigation.
 */
      ...
      <div className="max-w-6xl mx-auto">
        <article className="rounded-[30px] border border-[#e3d4c8] bg-[#6d4a3c] px-6 py-7 md:px-8 md:py-8 text-white shadow-[0_16px_45px_rgba(70,34,16,0.18)]">
          <div className="mb-6 flex items-start justify-between gap-4">
            <div>
              <p className="text-[11px] uppercase tracking-[0.24em] text-white/70 mb-2">Temoignages</p>
          ...
          {testimonials.length === 0 ? (
            <p className="text-sm text-white/80">Les temoignages seront bientot disponibles.</p>
          ) : (
            <>
              ...
              <div className="mt-8 rounded-[20px] border border-white/10 bg-white/5 px-4 py-4">
                ...
                <ul className="space-y-2 text-sm text-white/78">
                  {["Un accompagnement concret et progressif.", "Une identite editoriale mieux structuree.", "Un plan de diffusion plus clair et plus impactant."].map((t) => (
